 ...
 */
typedef unsigned short int javacall_utf16;

/**
 * @typedef javacall_int8
 * @brief 8 bit integer type
 */
typedef signed char javacall_int8;
 ...
 */
typedef unsigned short int javacall_uint16;

/**
 * @typedef javacall_uint32
 * @brief 32 bit unsigned integer type
 */
typedef unsigned int javacall_uint32;

/**
 * @typedef javacall_uint64
 * @brief 64 bit unsigned integer type
 */
typedef long long unsigned int javacall_uint64;
 ...
 */
typedef long long int javacall_int64;
 ...
 */
#define JAVACALL_MAX_LOCALIZED_DIR_NAME_LENGTH    256
