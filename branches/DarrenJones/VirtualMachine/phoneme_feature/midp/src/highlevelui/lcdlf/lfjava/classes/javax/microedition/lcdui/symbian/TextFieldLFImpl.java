 ...
 * This file has been modified by Blue Whale Systems on 05Apr2009.
    ...
    TextFieldLF, TextInputComponent, CommandListener 
{
	...
	protected int editPos;
	protected int editLength;
	protected boolean underline;
	protected boolean iModifiedByUser = false;
    ...
    public int paint(Graphics g,
        ...
        if (hasFocus) {
			if (underline)
			{
				newXOffset = Text.paintLine(g, str, font, fgColor, w, h, cursor, offset, editPos, editPos + editLength);
			}
			else
			{
				newXOffset = Text.paintLine(g, str, font, fgColor, w, h, cursor, offset, 0, 0);
			}
        } else {
	...
	public void update()
	{
		...
		String input = getString0(this.hashCode());
    ...
    */
    ...
    private void addInputCommands() {
        if ((inputModes != null) && (inputMenu != null)) {
			inputMenu.removeAll();
