...
#ifndef __TESTAUTOAPN_H__
#define __TESTAUTOAPN_H__
#include <cxxtest/TestSuite.h>
#include "EcomPlus.h"

class CTestAutoAPN: public CxxTest::TestSuite
{
public:
	CTestAutoAPN(const TDesC8& aSuiteName):CxxTest::TestSuite(aSuiteName)
	{}
private:
	void setUp();
	void tearDown();
