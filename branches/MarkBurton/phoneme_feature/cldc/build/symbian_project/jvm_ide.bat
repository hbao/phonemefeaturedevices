...
set BuildRoot=%BuildSpace%\sym_%JVM_ARCH%
...
set BuildToolSrcs=%BuildToolSrcs% %BuildToolSrcDir%\makedep\symbian\*.java
...
set BuildToolSrcs=%BuildToolSrcs% %BuildToolSrcDir%\..\..\..\..\tools\jpp\*.java
...
@rem create platform.cfg - platform configuration file
@rem ======================================================================
echo os_family= win32       > %BuildRoot%\platformwin32.cfg
echo arch     = i386        >> %BuildRoot%\platformwin32.cfg
echo os_arch  = win32_i386	>> %BuildRoot%\platformwin32.cfg
echo compiler = visCPP      >> %BuildRoot%\platformwin32.cfg

echo os_family= win32       > %BuildRoot%\platformwin32-rom.cfg
echo arch     = i386			>> %BuildRoot%\platformwin32-rom.cfg
echo os_arch  = win32_i386	>> %BuildRoot%\platformwin32-rom.cfg
echo compiler = visCPP      >> %BuildRoot%\platformwin32-rom.cfg
...
echo os_family= %JVM_OS%             > %BuildRoot%\platform.cfg
echo arch     = %JVM_ARCH%          >> %BuildRoot%\platform.cfg
echo iarch     = arm				>> %BuildRoot%\platform.cfg
echo os_arch  = %JVM_OS%_%JVM_ARCH% >> %BuildRoot%\platform.cfg
echo compiler = %JVM_COMPILER%      >> %BuildRoot%\platform.cfg
...
@rem ======================================================================
echo os_family= win32       > %BuildRoot%\platformwin32.cfg
echo arch     = arm        >> %BuildRoot%\platformwin32.cfg
echo iarch     = arm        >> %BuildRoot%\platformwin32.cfg
echo os_arch  = win32_i386	>> %BuildRoot%\platformwin32.cfg
echo compiler = visCPP      >> %BuildRoot%\platformwin32.cfg
echo host_arch = i386      >> %BuildRoot%\platformwin32.cfg
