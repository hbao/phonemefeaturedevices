...
#ifdef __DEBUGNIMIMPL__
#define DEBUGMSG(_AA) { pcsl_print(_AA);}
#else
#define DEBUGMSG(_AA)
#endif
...
static constraint_map flags = {
        ...
        { KNI_TRUE, KNI_TRUE, KNI_TRUE, KNI_TRUE, KNI_TRUE, KNI_TRUE }, // IS_FULLWIDTH_DIGITS
        { KNI_TRUE, KNI_TRUE, KNI_TRUE, KNI_TRUE, KNI_TRUE, KNI_TRUE }, // IS_FULLWIDTH_LATIN
        { KNI_TRUE, KNI_TRUE, KNI_TRUE, KNI_TRUE, KNI_TRUE, KNI_TRUE }, // IS_HALFWIDTH_KATAKANA
        { KNI_TRUE, KNI_TRUE, KNI_TRUE, KNI_TRUE, KNI_TRUE, KNI_TRUE }, // IS_HANJA
        { KNI_TRUE, KNI_TRUE, KNI_TRUE, KNI_TRUE, KNI_TRUE, KNI_TRUE }, // IS_KANJI
        { KNI_TRUE, KNI_TRUE, KNI_TRUE, KNI_TRUE, KNI_TRUE, KNI_TRUE }, // IS_LATIN
        { KNI_TRUE, KNI_TRUE, KNI_TRUE, KNI_TRUE, KNI_TRUE, KNI_TRUE }, // IS_LATIN_DIGITS
        { KNI_TRUE, KNI_TRUE, KNI_TRUE, KNI_TRUE, KNI_TRUE, KNI_TRUE }, // IS_SIMPLIFIED_HANZI
        { KNI_TRUE, KNI_TRUE, KNI_TRUE, KNI_TRUE, KNI_TRUE, KNI_TRUE }, // IS_TRADITIONAL_HANZI
        { KNI_TRUE, KNI_TRUE, KNI_TRUE, KNI_TRUE, KNI_TRUE, KNI_TRUE }, // MIDP_UPPERCASE_LATIN
        { KNI_TRUE, KNI_TRUE, KNI_TRUE, KNI_TRUE, KNI_TRUE, KNI_TRUE }, // MIDP_LOWERCASE_LATIN
        { KNI_TRUE, KNI_TRUE, KNI_TRUE, KNI_TRUE, KNI_TRUE, KNI_TRUE }  // NULL
};
...
void nim_begin_input(jint id, jint* pInstanceData, const pcsl_string* inputSubset, int constraints) {
    (void)id;
    (void)inputSubset;
    DEBUGMSG("nim_begin_input\n");
	static_cast<MApplication*>(Dll::Tls())->BeginEditSession(*pInstanceData, constraints);
}
...
jint nim_process_key(jint id, jint* pInstanceData, jint key, jboolean longPress, jint isClearKey, state_data* state, pcsl_string* stringRes) {
    ...
    (void)state;
    (void)stringRes;
	DEBUGMSG("nim_process_key\n");
	int ret = 0;
	HBufC* buffer = NULL;
	(*state)[STATE_FUNC_TOKEN] = static_cast<MApplication*>(Dll::Tls())->GetNextState();
	(*state)[STATE_NEXT_STATE] = 1; // indicate that we want to be called again
	(*state)[STATE_FINAL_RES] = 1; // key handled
			
	switch((*state)[STATE_FUNC_TOKEN])
	{
		case MEDIATOR_UPDATE:
			break;
		case MEDIATOR_CLEAR:
			(*state)[STATE_INT_ARG] = 1;
			break;
		default:
			(*state)[STATE_FINAL_RES] = 0; // false
			(*state)[STATE_NEXT_STATE] = 0;	// end of state machine run
	}
...
void nim_end_input(jint id, jint* pInstanceData) {
    (void)id;
    (void)pInstanceData;
	DEBUGMSG("nim_end_input\n");
	static_cast<MApplication*>(Dll::Tls())->EndEditSession();
}
