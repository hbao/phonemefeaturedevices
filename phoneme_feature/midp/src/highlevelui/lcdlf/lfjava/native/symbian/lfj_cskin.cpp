...
KNIDECL(com_sun_midp_chameleon_skins_resources_LoadedSkinData_readByteArray) {
    ...
    do {
        ...
        KNI_SetRawArrayRegion(returnArray, 0, arrayLength, (const signed char*)gsSkinFileDataPos);
...
KNIDECL(com_sun_midp_chameleon_skins_resources_LoadedSkinData_readIntArray) {
    ...
    do {
         ...
         */
        KNI_SetRawArrayRegion(returnArray, 0, totalBytes, (const signed char*)gsSkinFileDataPos);
    ...
    do {
        ...
        for (i = 0; i < arrayLength; ++i) {
            ...
            if (encoding == STRING_ENCODING_USASCII) {    
                ...
                KNI_NewStringUTF((const char*)gsSkinFileDataPos, stringHandle);
            } else {
                KNI_ThrowNew(midpIllegalStateException, 
