...
{
	static_cast<MApplication*>(Dll::Tls())->Refresh(x1,y1,x2,y2);
}
...
{
	static_cast<MApplication*>(Dll::Tls())->SetFullScreenMode(mode);
	resizeScreenBuffer();
}
...
{
	return static_cast<MApplication*>(Dll::Tls())->FullScreenMode();
}
...
{
	return static_cast<MApplication*>(Dll::Tls())->GetScreenWidth();
}
...
{
    return static_cast<MApplication*>(Dll::Tls())->GetScreenHeight();
}
