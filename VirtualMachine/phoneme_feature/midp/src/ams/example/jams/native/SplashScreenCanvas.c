...
void DrawSplashScreen()
{
	...
	draw_roundrect(GXJ_RGB24TORGB16(fillColor), clip, &gxj_system_screen_buffer, 0, 0, 0, gxj_system_screen_buffer.width, gxj_system_screen_buffer.height, 1, 0, 0);
}
