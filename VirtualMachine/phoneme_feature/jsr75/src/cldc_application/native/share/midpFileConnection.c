...
Java_com_sun_cdc_io_j2me_file_DefaultFileHandler_create()
{
 ...
 */
KNIEXPORT KNI_RETURNTYPE_VOID
Java_com_sun_cdc_io_j2me_file_DefaultFileHandler_delete()
{
    const pcsl_string * fileName = NULL;
    int existStatus      = 0;
    int deleteStatus     = -1;
 ...
 */
KNIEXPORT KNI_RETURNTYPE_VOID
Java_com_sun_cdc_io_j2me_file_DefaultFileHandler_rename0()
{
    pcsl_string * fileName      = NULL;
 ...
 */
KNIEXPORT KNI_RETURNTYPE_VOID
Java_com_sun_cdc_io_j2me_file_DefaultFileHandler_truncate()
{
    const pcsl_string * fileName    = NULL;
    int         existStatus = -1;
    int         openStatus  = -1;
...
Java_com_sun_cdc_io_j2me_file_DefaultFileHandler_fileSize()
{
    const pcsl_string * fileName = NULL;
    jlong       res      = -1L;
 ...
 */
KNIEXPORT KNI_RETURNTYPE_LONG
Java_com_sun_cdc_io_j2me_file_DefaultFileHandler_directorySize()
{
    const pcsl_string * fileName = NULL;
    int                 recurse  = 0;
    jlong               res      = (jlong)(-1);
 ...
 */
KNIEXPORT KNI_RETURNTYPE_VOID
Java_com_sun_cdc_io_j2me_file_DefaultFileHandler_mkdir()
{
    const pcsl_string * fileName = NULL;
    int         res      = -1;
...
Java_com_sun_cdc_io_j2me_file_DefaultFileHandler_exists()
{
    const pcsl_string * fileName = NULL;
    int         exist    = 0;
 ...
 */
KNIEXPORT KNI_RETURNTYPE_BOOLEAN
Java_com_sun_cdc_io_j2me_file_DefaultFileHandler_isDirectory()
{
    const pcsl_string * fileName = NULL;
    int         dirExist = 0;
    jboolean    res      = KNI_FALSE;
 ...
 */
KNIEXPORT KNI_RETURNTYPE_BOOLEAN
Java_com_sun_cdc_io_j2me_file_DefaultFileHandler_canRead()
{
    const pcsl_string * fileName = NULL;
    int         value    = 0;
    int         status   = -1;
 ...
 */
KNIEXPORT KNI_RETURNTYPE_VOID
Java_com_sun_cdc_io_j2me_file_DefaultFileHandler_setReadable()
{
    const pcsl_string * fileName = NULL;
    int         status   = -1;
    int         newvalue = 0;
 ...
 */
KNIEXPORT KNI_RETURNTYPE_BOOLEAN
Java_com_sun_cdc_io_j2me_file_DefaultFileHandler_canWrite()
{
    const pcsl_string * fileName = NULL;
    int         value    = 0;
    int         status   = -1;
 ...
 */
KNIEXPORT KNI_RETURNTYPE_VOID
Java_com_sun_cdc_io_j2me_file_DefaultFileHandler_setWritable()
{
    const pcsl_string * fileName = NULL;
    int         status   = -1;
    int         newvalue = 0;
 ...
 */
KNIEXPORT KNI_RETURNTYPE_BOOLEAN
Java_com_sun_cdc_io_j2me_file_DefaultFileHandler_isHidden0()
{
    const pcsl_string * fileName = NULL;
    jboolean    res      = KNI_FALSE;
    int         status   = -1;
 ...
 */
KNIEXPORT KNI_RETURNTYPE_VOID
Java_com_sun_cdc_io_j2me_file_DefaultFileHandler_setHidden0()
{
    const pcsl_string * fileName = NULL;
    int         status   = -1;
    int         newvalue = 0;
 ...
 */
KNIEXPORT KNI_RETURNTYPE_LONG
Java_com_sun_cdc_io_j2me_file_DefaultFileHandler_openDir()
{
    const pcsl_string * fileName = NULL;
 ...
 */
KNIEXPORT KNI_RETURNTYPE_VOID
Java_com_sun_cdc_io_j2me_file_DefaultFileHandler_closeDir()
{    
    void* fileList = NULL;
    int   status   = -1;
...
Java_com_sun_cdc_io_j2me_file_DefaultFileHandler_dirGetNextFile()
{
    const pcsl_string * fileName      = NULL;
    PCSL_DEFINE_ASCII_STRING_LITERAL_START(sep)
#ifdef __unix__
 ...
 */
KNIEXPORT KNI_RETURNTYPE_OBJECT
Java_com_sun_cdc_io_j2me_file_DefaultFileHandler_getMountedRoots(void)
{
    char* roots = NULL;
 ...
 */
KNIEXPORT KNI_RETURNTYPE_OBJECT
Java_com_sun_cdc_io_j2me_file_DefaultFileHandler_getNativePathForRoot()
{    
 ...
 */
KNIEXPORT KNI_RETURNTYPE_LONG
Java_com_sun_cdc_io_j2me_file_DefaultFileHandler_lastModified()
{
    const pcsl_string * fileName = NULL;
    jlong       res      = 0;
    long        time     = 0;
 ...
 */
KNIEXPORT KNI_RETURNTYPE_VOID
Java_com_sun_cdc_io_j2me_file_DefaultFileHandler_openForRead()
{    
    const pcsl_string * fileName   = NULL;
    void*       handle     = NULL;
    int         dirStatus  = 0;
 ...
 */
KNIEXPORT KNI_RETURNTYPE_VOID
Java_com_sun_cdc_io_j2me_file_DefaultFileHandler_openForWrite()
{
    const pcsl_string * fileName   = NULL;
    void*       handle     = NULL;
    int         dirStatus  = 0;
...
Java_com_sun_cdc_io_j2me_file_DefaultFileHandler_read()
{
    void*  handle = NULL;    
    jint   res    = 0;    
    jbyte* data  = NULL;
 ...
 */
KNIEXPORT KNI_RETURNTYPE_INT
Java_com_sun_cdc_io_j2me_file_DefaultFileHandler_write()
{
    void*  handle = NULL;
    jint   res    = 0;
    jbyte* data   = NULL;
 ...
 */
KNIEXPORT KNI_RETURNTYPE_VOID
Java_com_sun_cdc_io_j2me_file_DefaultFileHandler_positionForWrite()
{    
    void*       handle   = NULL;
    long        offset   = 0;
    long        seek     = 0;
 ...
 */
KNIEXPORT KNI_RETURNTYPE_VOID
Java_com_sun_cdc_io_j2me_file_DefaultFileHandler_flush()
{
    int   status = -1;
    void* handle = NULL;
 ...
 */
KNIEXPORT KNI_RETURNTYPE_LONG
Java_com_sun_cdc_io_j2me_file_DefaultFileHandler_availableSize()
{
 ...
 */
KNIEXPORT KNI_RETURNTYPE_LONG
Java_com_sun_cdc_io_j2me_file_DefaultFileHandler_totalSize()
{
    const pcsl_string * rootName = NULL;
    jlong       res      = -1L; /* -1 if the file system is not accessible*/
 ...
 */
KNIEXPORT KNI_RETURNTYPE_VOID
Java_com_sun_cdc_io_j2me_file_DefaultFileHandler_closeForRead()
{
 ...
 */
KNIEXPORT KNI_RETURNTYPE_VOID
Java_com_sun_cdc_io_j2me_file_DefaultFileHandler_closeForWrite()
{    
 ...
 */
KNIEXPORT KNI_RETURNTYPE_VOID
Java_com_sun_cdc_io_j2me_file_DefaultFileHandler_closeForReadWrite()
{
 ...
 */
KNIEXPORT KNI_RETURNTYPE_VOID
Java_com_sun_cdc_io_j2me_file_DefaultFileHandler_close()
{
    DEBUG_PRINT("close");
 ...
 */
KNIEXPORT KNI_RETURNTYPE_LONG
Java_com_sun_cdc_io_j2me_file_DefaultFileHandler_getNativeName()
{
    jlong       lname         = 0;
...
KNIEXPORT KNI_RETURNTYPE_OBJECT
Java_com_sun_cdc_io_j2me_file_DefaultFileHandler_illegalFileNameChars0()
{
...
Java_com_sun_cdc_io_j2me_file_DefaultFileHandler_getFileSeparator()
{    
 ...
 */
KNIEXPORT KNI_RETURNTYPE_VOID
Java_com_sun_cdc_io_j2me_file_DefaultFileHandler_finalize()
{
 ...
 */
KNIEXPORT KNI_RETURNTYPE_VOID
Java_com_sun_cdc_io_j2me_file_DefaultFileHandler_initialize()
{
