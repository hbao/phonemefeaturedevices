...
{
	TPtr16 ptr1((TUint16*)string1, nchars, nchars);
	TPtr16 ptr2((TUint16*)string2, nchars, nchars);
    return ptr1.CompareF(ptr2);
}
...
extern "C" {
#endif
wchar_t* javautil_wcsrchr(wchar_t* str, wchar_t c)
{
	if (NULL == str)
	{
		return NULL;
